        ...
        <div className="flex items-center justify-between gap-3 sm:gap-6">
          ...
          <a href="#" className="flex items-center gap-2.5 shrink-0 group">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xl sm:text-2xl font-black text-blue-600 tracking-tight">Student</span>
                <span className="text-[9px] bg-slate-100 text-slate-800 border border-slate-200 font-bold px-1.5 py-0.5 rounded-md ml-1 tracking-wider">
                  CẦN THƠ
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            >
              ...
              {orderCount > 0 && (
                <span className="bg-blue-600 text-white font-bold text-[10px] px-1.5 py-0.2 rounded-full">
                  {orderCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs font-bold text-blue-600 leading-tight">08.1800 6881</div>
              </div>
            </a>
            ...
            >
              <div className="relative">
                <ShoppingCart className="w-5 h-5 transition" />
                {cartCount > 0 && (
                  <span className="absolute -top-2.5 -right-2.5 bg-blue-800 text-white font-black text-[10px] w-5 h-5 rounded-full flex items-center justify-center border-2 border-white">
                    {cartCount}
                  </span>
                )}
              </div>
              ...
              <div className="hidden sm:flex flex-col items-start leading-none text-left">
                <span className="text-[10px] text-blue-100 font-medium">Giỏ Hàng SV</span>
